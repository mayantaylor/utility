...
namespace Tipsy
{
	...
	void TipsyStats::clear()
	{
		...
		center = size = center_of_mass = gas_com = dark_com = star_com = center_of_mass_velocity = gas_com_vel = dark_com_vel = star_com_vel = angular_momentum = gas_ang_mom = dark_ang_mom = star_ang_mom = Vector3D<double>();
		min_mass = gas_min_mass = dark_min_mass = star_min_mass = min_radius = gas_min_radius = dark_min_radius = star_min_radius = min_velocity = gas_min_velocity = dark_min_velocity = star_min_velocity = dark_min_eps = star_min_eps = min_phi = gas_min_phi = dark_min_phi = star_min_phi = gas_min_rho = gas_min_temp = gas_min_hsmooth = gas_min_metals = star_min_metals = star_min_tform = HUGE_VAL;
		max_mass = gas_max_mass = dark_max_mass = star_max_mass = max_radius = gas_max_radius = dark_max_radius = star_max_radius = max_velocity = gas_max_velocity = dark_max_velocity = star_max_velocity = dark_max_eps = star_max_eps = max_phi = gas_max_phi = dark_max_phi = star_max_phi = gas_max_rho = gas_max_temp = gas_max_hsmooth = gas_max_metals = star_max_metals = star_max_tform = -HUGE_VAL;
	}
